...
const settings = { minValue: 100_000_000, minBidOfferRatio: 1.3, transactionCost: .3, targetPct: 1.5, stopPct: .9, requireExactOrderBook: true, strategyMode: 'balanced' as const, rsiMin: 55, rsiMax: 72, minRelativeVolume: 1.5, minCandleBodyRatio: .45, minCloseLocation: .65, minBuyFlow: .55, maxSpreadTicks: 2, minOrderBookPersistence: 3 }
