...
export function EquityChart({ stats }: { stats: BacktestStats }) {
  ...
  return <section className="panel chart-panel">
    <div className="panel-heading"><h2>Kinerja strategi</h2><span>30 hari · Demo</span></div>
    ...
    <div className="mini-stats">
      <div><span>Total return</span><strong className={stats.totalReturn >= 0 ? 'positive' : 'negative'}>{pct(stats.totalReturn, true)}</strong></div>
