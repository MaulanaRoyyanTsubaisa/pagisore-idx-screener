...
export function PanicPanel({ payload, loading }: { payload: PanicPayload | null; loading: boolean }) {
  ...
  return <section className="panic-panel" aria-labelledby="panic-title">
    <div className="panic-heading">
      <div><span className="eyebrow"><Zap size={14} /> SINYAL UTAMA · INI YANG DIGUNAKAN</span><h2 id="panic-title">Panic Limit · ikuti urutan prioritas</h2><p>Dahulukan Tier A, lalu Tier B · maksimal {maxPositions} antrean · hanya jika buy limit final tersentuh</p></div>
    ...
    <div className="panic-proof">
      <div><b>Tier A · turun ≤−12%</b><span>Validasi avg +0,91% / PF 1,44 · holdout +2,06% / PF 1,91</span></div>
      <div><b>Tier B · turun −6% s.d. −5%</b><span>Validasi avg +0,50% / PF 1,35 · holdout +0,20% / PF 1,10</span></div>
